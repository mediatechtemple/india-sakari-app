...
import 'advertisement_page.dart'; // Import the AdvertisementPage here
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Add the "Advertisement With Us" clickable heading here
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AdvertisementPage(), // Correctly navigate to AdvertisementPage
                    ),
                  );
                },
                child: Container(
...
// Create the AdvertisementPage as a StatelessWidget
class AdvertisementPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Advertisement With Us"), // Set title for the page
      ),
      body: Center(
        child: Text("Here, you can display the advertisement details."),
      ),
    );
  }
}
